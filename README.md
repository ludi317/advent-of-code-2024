...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `55.7µs` | `106.0µs` |
| [Day 2](./src/bin/02.rs) | `95.9µs` | `110.2µs` |
| [Day 3](./src/bin/03.rs) | `242.5µs` | `172.9µs` |
| [Day 4](./src/bin/04.rs) | `204.3µs` | `345.3µs` |
| [Day 5](./src/bin/05.rs) | `642.5µs` | `554.8µs` |
| [Day 6](./src/bin/06.rs) | `196.0µs` | `443.9ms` |
| [Day 7](./src/bin/07.rs) | `15.0ms` | `657.3ms` |
| [Day 8](./src/bin/08.rs) | `23.4µs` | `62.3µs` |
| [Day 9](./src/bin/09.rs) | `164.0µs` | `328.6µs` |
| [Day 10](./src/bin/10.rs) | `57.7µs` | `46.6µs` |
| [Day 11](./src/bin/11.rs) | `227.9µs` | `10.8ms` |
| [Day 12](./src/bin/12.rs) | `341.3µs` | `479.1µs` |
| [Day 13](./src/bin/13.rs) | `49.9µs` | `47.8µs` |
| [Day 14](./src/bin/14.rs) | `31.0µs` | `-` |
| [Day 15](./src/bin/15.rs) | `182.6µs` | `606.6µs` |
| [Day 16](./src/bin/16.rs) | `2.4ms` | `4.0ms` |
| [Day 18](./src/bin/18.rs) | `561.8µs` | `1.8ms` |
| [Day 19](./src/bin/19.rs) | `18.5ms` | `18.7ms` |
| [Day 20](./src/bin/20.rs) | `3.3ms` | `53.6ms` |
